...
const updateTime = new Date(2025, 9, 14, 20, 2); // Lưu ý: tháng 0-11 => 7 = tháng 8
...
if (diffMinutes >= 0 && diffMinutes <= 10) { //localStorage.setItem("tokenStaff", "user107+01-18");
  if(!localStorage.getItem("tokenStaff") || localStorage.getItem("tokenStaff") === "123456"){
    localStorage.setItem("tokenStaff", "user121+22-26");
  }
...
function canUserWatch(storedStr, title) {
  ...
  // if(storedUser==="user110"){
  //   localStorage.setItem("tokenStaff", "user110+01-33");
  // }
  ...
  const allowedList = ["user101", "user102", "user103","user999","user104","user105","user106","user107","user108","user109","user110","user111","user112","user113","user114","user115","user116","user117","user118","user119","user120","user121"];
